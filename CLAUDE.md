...
- 首页主转化固定为免费安装，截止 2026 年 10 月 1 日 23:59（北京时间）的 ¥29 早鸟永久价作为次级转化；截止前支付成功的用户永久保留权益。普通页面的安装入口统一进入 `/download/`，购买入口统一进入 `/purchase/`，只有这两个选择页可以继续连接 Chrome Web Store、本站 ZIP 或 `https://ai.bzjkmn.cn/cat/28`
